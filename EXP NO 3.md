...
.bgimg {
  ...
  background-image: url("http://t1.gstatic.com/licensed-image?q=tbn:ANd9GcSnCn9k-c100ccJnb6N8Odb8Ge-6iisByej4f6xu-rSmo4tKAxxcWz_AOgH8f1THy55");
  min-height: 90%;
}
</style>
</head>
...
<header class="bgimg w3-display-container w3-grayscale-min" id="home">
  <div class="w3-display-bottomleft w3-padding">
    <span class="w3-tag w3-xlarge">Open from 9am to 9pm</span>
  </div>
...
<div class="w3-container w3-black w3-padding-64 w3-xxlarge" id="menu">
  <div class="w3-content">
    ...
    <div id="Starter" class="w3-container menu w3-padding-32 w3-white">
      ...
      <h1><b>Garlic bread</b> <span class="w3-right w3-tag w3-dark-grey w3-round">RS.90</span></h1>
